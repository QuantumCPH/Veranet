...
/**
 * EmailAlertSent form base class.
 *
 * @package    zapnacrm
 * @subpackage form
 * @author     Your name here
 */
class BaseEmailAlertSentForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                    => new sfValidatorPropelChoice(array('model' => 'EmailAlertSent', 'column' => 'id', 'required' => false)),
