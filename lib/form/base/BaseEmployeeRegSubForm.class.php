...
/**
 * EmployeeRegSub form base class.
 *
 * @package    zapnacrm
 * @subpackage form
 * @author     Your name here
 */
class BaseEmployeeRegSubForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                  => new sfValidatorPropelChoice(array('model' => 'EmployeeRegSub', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('employee_reg_sub[%s]');
