<div id="sf_admin_container" style="clear: both;">
    <h2>Available Balance: <?php echo format_number($balance,2); ?><?php echo sfConfig::get('app_currency_code');?></h2>
    <h2>Credit Limit:  <?php echo  format_number($company->getCreditLimit(),2);  ?><?php echo sfConfig::get('app_currency_code');?></h2><br/>
   ...
   <tr <?php echo $class ?>>
        ...
        <td><?php
           ...
           // $ct->add(TelintaAccountsPeer::ACCOUNT_TITLE, sfConfig::get("app_telinta_emp") . $company->getId() . $employee->getId());
            ...
            echo format_number($accountInfo->account_info->balance,2);
